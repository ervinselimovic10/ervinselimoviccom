...
<div class="container">
  <div class="row">
    ...
    <div class="auto">
      ...
      <h3><img src="/assets/img/{{ $page->picture }}" class="postimg" alt="onesneros {{ $page->title }}"/> {{ $page->title }} <a href="{{ $page->slug }}" class="links"><span class="glyphicon glyphicon-menu-down"></span></a></h3>
